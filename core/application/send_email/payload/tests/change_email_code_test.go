...
func TestChangeEmailCodePayloadIsCreatedCorrectly(t *testing.T) {
	actualPayload, err := payload.NewChangeEmailCodePayload(
		to, subject, verificationCode, changeEmailCodeTemplatePath,
		codeExpiratinoHours,
	)
